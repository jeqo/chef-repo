...
# Unzip installers
installer_zip = File.join(Chef::Config[:file_cache_path], "fmw_#{node['soa_qs-12c']['version']}.0.0_bpmqs_Disk1_1of1.zip")
installer_jar_path = File.join(Chef::Config[:file_cache_path], "fmw_#{node['soa_qs-12c']['version']}.0.0_bpm_quickstart.jar")
